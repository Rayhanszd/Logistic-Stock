...
if (!isset($_SESSION['username']) || $_SESSION['role'] != 'owner') {
    header('Location: login.php'); // Arahkan ke halaman login jika belum login atau bukan owner
    exit;
}
...
<body>
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between mb-4">
            ...
            <a href="history_transaksi.php" class="btn btn-info">History Transaksi</a> <!-- Tombol History Transaksi -->
